 ...
 *
 * Em JavaScript, e não TypeScript, por duas razões medidas: `cpu-limit.spec.js`
 * ao lado já é JS (convenção da pasta), e `tsconfig.json` fixa `rootDir: ./src`
 * — um `.ts` aqui reprova `npm run typecheck` com TS6059.
 */
